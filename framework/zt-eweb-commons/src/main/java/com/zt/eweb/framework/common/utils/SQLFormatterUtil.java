...
public class SQLFormatterUtil {
    ...
    private static class FormatProcess {
        ...
        private void endNewClause() {
            if (!afterBeginBeforeEnd) {
                ...
                if("FROM".equals(token) || "WHERE".equals(token)){
                    result.append("\n");
                    beginLine = true;
                }else {
                    newline();
    ...
    public static void main(String[] args) {
        String sql = "CREATE VIEW YZST2 AS SELECT JEC_DYZB.JEC_DYZB_ID AS JEC_DYZB_ID, JEC_DYZB.DYZB_LDHTLX_CODE AS DYZB_LDHTLX_CODE, JEC_DYZB.DYZB_ZD2 AS DYZB_ZD2, JEC_DYZB.DYZB_LDHTLX_NAME AS DYZB_LDHTLX_NAME, JEC_DYZB.DYZB_ZD41 AS DYZB_ZD41\n" +
