...
public enum PlatformExceptionEnum {
     ...
     * 升级功能打包异常
     */
    JE_SYS_INSTALL_UPGRADE_PACKAGE_ERROR("2315"),
    /**
     * 平台文档附件异常
     */
    JE_DOC_ERROR("3000"),
     ...
     * 导入插件失败
     */
    APP_IMPORTPLUGIN_ERROR("9002"),
    /**
     * APP license未授权
     */
    APP_LICESNSE_UNAUTHORIZED("9003"),
    /**
     * 未找到相应的apk
     */
    APK_UNKOWN_ERROR("9004"),
    /**
     * 安全模式变量不一致
     */
    JE_SECURITY_PARAMPW_ERROR("9005"),
    /**
     * 获取数据库连接失败
     */
    CONNECTION_ERROR("9100"),
    /**
     * session过期
     */
    SESSION_EXPIRES("9101"),
    /**
     * 未注册
     */
    UNREGISTERED("9102"),
     ...
     * 订单查询
     */
    JEPAAS_QUERY_ORDER("9104"),
    /**
     * 关闭订单
     */
    JEPAAS_CLOSE_ORDER("9105"),
    /**
     * 第三方认证错误
     */
    AUTH_THIRD_ERROR("9200"),
    /**
     * 统一认证集成错误
     */
    AUTH_ERROR("9400"),
