package com.zt.eweb.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${eweb.websocket.sender-rocketmq.topic}",
        consumerGroup = "${eweb.websocket.sender-rocketmq.consumer-group}",
