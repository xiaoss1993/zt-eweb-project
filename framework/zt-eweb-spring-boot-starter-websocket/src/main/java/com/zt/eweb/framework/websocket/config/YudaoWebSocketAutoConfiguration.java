package com.zt.eweb.framework.websocket.config;

import com.zt.eweb.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.zt.eweb.framework.mq.redis.core.RedisMQTemplate;
import com.zt.eweb.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.zt.eweb.framework.websocket.core.listener.WebSocketMessageListener;
import com.zt.eweb.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.zt.eweb.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.zt.eweb.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.zt.eweb.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.zt.eweb.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.zt.eweb.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.zt.eweb.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.zt.eweb.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.zt.eweb.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.zt.eweb.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.zt.eweb.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.zt.eweb.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.zt.eweb.framework.websocket.core.session.WebSocketSessionManager;
import com.zt.eweb.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "eweb.websocket", value = "enable", matchIfMissing = true)
// 允许使用 eweb.websocket.enable=false 禁用 websocket
...
public class YudaoWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "eweb.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "eweb.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "eweb.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${eweb.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "eweb.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${eweb.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "eweb.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${eweb.websocket.sender-kafka.topic}") String topic) {
