...
public class ResultAssembler {
   ...
   * @param <E>
   */
  public static <E> void bindCountPropValue(String setterFieldName, List<E> fromList,
      String[] getterFields, Map valueMatchMap) {
   ...
   * @param <E>
   */
  public static <E> void bindPropValue(String setterFieldName, List<E> fromList,
      String[] getterFields, Map valueMatchMap, String splitBy) {
    if (V.isEmpty(fromList) || V.isEmpty(valueMatchMap)) {
      return;
    }
    try {
      for (E object : fromList) {
        ...
        if (valueMatchMap.containsKey(matchKey)) {
          ...
          if (matchKeys.size() == 1 && V.notEmpty(splitBy) && getterFields.length == 1
   ...
   * @param <E>
   */
  public static <E> void bindEntityPropValue(String setterFieldName, List<E> fromList,
      Map<String, String> trunkObjColMapping, Map valueMatchMap,
      Map<String, String> col2FieldMapping) {
    if (V.isEmpty(fromList) || V.isEmpty(valueMatchMap)) {
      return;
    }
   ...
   * @param <E>
   */
  public static <E> void bindFieldListPropValue(List<E> fromList, String[] getterFields,
      Map<String, List> valueMatchMap,
   ...
   * @return
   */
  public static <E> Map<String, Object> convertToOneToOneResult(
      List<Map<String, E>> resultSetMapList, Map<String, String> trunkObjColMapping,
      Map<String, String> branchObjColMapping) {
    ...
    for (Map<String, E> row : resultSetMapList) {
      ...
      Object valueObj =
          row.containsKey(valueName) ? row.get(valueName) : row.get(valueName.toUpperCase());
   ...
   * @return
   */
  public static <E> Map<String, Long> convertToOneToManyCountResult(
      List<Map<String, E>> resultSetMapList, Map<String, String> trunkObjColMapping,
      Map<String, String> branchObjColMapping) {
    if (V.isEmpty(resultSetMapList)) {
      return Collections.emptyMap();
   ...
   * @return
   */
  public static <E> Map<String, List> convertToOneToManyResult(
      List<Map<String, E>> resultSetMapList, Map<String, String> trunkObjColMapping,
      Map<String, String> branchObjColMapping) {
    if (V.isEmpty(resultSetMapList)) {
      return Collections.emptyMap();
        ...
        if (V.notEmpty(splitBy)) {
          ...
          if (valueStr.contains(splitBy)) {
            for (String oneVal : valueStr.split(splitBy)) {
              Object oneValueObj =
                  isSameType ? oneVal : BeanUtils.convertValueToFieldType(oneVal, fieldType);
            ...
            Object oneValueObj =
                isSameType ? value : BeanUtils.convertValueToFieldType(value, fieldType);
            if (!newValueList.contains(oneValueObj)) {
              newValueList.add(oneValueObj);
            }
          }
