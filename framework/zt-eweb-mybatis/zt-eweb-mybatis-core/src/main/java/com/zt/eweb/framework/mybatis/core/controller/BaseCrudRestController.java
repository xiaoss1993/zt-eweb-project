...
public class BaseCrudRestController<E extends AbstractEntity> extends BaseController {
   ...
   * @throws Exception
   */
  protected <VO> JsonResult<List<VO>> getViewObjectList(E entity, Pagination pagination,
      Class<VO> voClass) throws Exception {
  ...
  @Deprecated
  protected <VO> JsonResult<List<VO>> getViewObjectList(E entity, Pagination pagination,
      Class<VO> voClass, boolean buildQueryWrapperByDTO) throws Exception {
    //DTO全部属性参与构建时调用
   ...
   * @throws Exception
   */
  protected JsonResult<List<E>> getEntityListWithPaging(Wrapper<?> queryWrapper,
