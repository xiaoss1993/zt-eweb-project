...
import com.zt.eweb.framework.mybatis.core.util.SqlExecutor;
...
public class MiddleTable {
  ...
  public Map<String, Object> executeOneToOneQuery(Map<String, List> trunkObjCol2ValuesMap) {
    ...
    if (linkage != null) {
      ...
      // 执行查询并合并结果
      try {
        List<Map<String, Object>> resultSetMapList = SqlExecutor.executeQuery(sql,
  ...
  public Map<String, Long> executeOneToManyCountQuery(Map<String, List> trunkObjCol2ValuesMap) {
    ...
    if (linkage != null) {
      List<Map<String, Object>> resultSetMapList = queryByMapper(linkage, trunkObjCol2ValuesMap,
          true);
      return ResultAssembler.convertToOneToManyCountResult(resultSetMapList, trunkObjColMapping,
          branchObjColMapping);
    } else {
   ...
   * @return
   */
  private List<Map<String, Object>> queryByMapper(EntityInfoCache linkage,
      Map<String, List> trunkObjCol2ValuesMap) {
   ...
   */
  private List<Map<String, Object>> queryByMapper(EntityInfoCache linkage,
      Map<String, List> trunkObjCol2ValuesMap, boolean isCount) {
