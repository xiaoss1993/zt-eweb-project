 ...
 * @author JerryMa
 * @version v2.4.0
 * @date 2021/11/16 Copyright © diboot.com
 */
@Slf4j
@Component
public class ParallelBindingManager {
   ...
   */
  @Async
  public CompletableFuture<Boolean> doBindingFieldList(List voList,
      List<FieldAnnotation> fieldAnnotations) {
   ...
   */
  @Async
  public CompletableFuture<Boolean> doBindingEntityList(List voList,
