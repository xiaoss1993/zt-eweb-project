  ...
  public void bind() {
    ...
    if (middleTable == null) {
      ...
      if (V.notEmpty(countMapList)) {
        ...
        ResultAssembler.bindCountPropValue(annoObjectField, super.getMatchedAnnoObjectList(),
            getAnnoObjJoinFlds(), valueListCountMap);
      }
    } else {
      ...
      Map<String, Long> middleTableCountResultMap = middleTable.executeOneToManyCountQuery(
