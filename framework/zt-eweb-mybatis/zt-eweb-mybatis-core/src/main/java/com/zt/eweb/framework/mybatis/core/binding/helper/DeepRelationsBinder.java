...
import com.zt.eweb.framework.mybatis.core.binding.RelationsBinder;
...
public class DeepRelationsBinder {
   ...
   * @param <VO>
   */
  public static <VO> void deepBind(List<VO> voList, List<FieldAnnotation> deepBindEntityAnnoList,
      List<FieldAnnotation> deepBindEntitiesAnnoList) {
    if (V.isEmpty(voList)) {
      return;
    }
    // 收集待深度绑定的对象集合, 绑定第二层
