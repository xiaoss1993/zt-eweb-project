 ...
 * @author Yangzhao
 * @version 2.0.0
 * @date 2020/12/8 10:07 上午 Copyright © diboot.com
 */
@Getter
@Setter
@Accessors(chain = true)
public class BatchUpdateEntitiesDTO<T extends AbstractEntity<ID_TYPE>, ID_TYPE extends Serializable> implements
    Serializable {
