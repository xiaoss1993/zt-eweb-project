...
public class EntityInfoCache implements Serializable {
  ...
  public IService getService() {
    return this.serviceBeanName == null ? null
        : (IService) ContextHolder.getApplicationContext().getBean(this.serviceBeanName);
  }
  ...
  public BaseMapper getBaseMapper() {
    return mapperClass == null ? getService().getBaseMapper()
        : ContextHolder.getBean(this.mapperClass);
  }
