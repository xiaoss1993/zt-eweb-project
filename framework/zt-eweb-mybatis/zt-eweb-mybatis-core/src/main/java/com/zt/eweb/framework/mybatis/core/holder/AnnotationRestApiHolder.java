...
package com.zt.eweb.framework.mybatis.core.holder;
...
import com.zt.eweb.framework.mybatis.core.holder.api.CollectThisApi;
import com.zt.eweb.framework.mybatis.core.holder.api.RestApi;
import com.zt.eweb.framework.mybatis.core.holder.api.RestApiWrapper;
...
public class AnnotationRestApiHolder {
  ...
  private static void buildRestApisInClass(RestApiWrapper wrapper, Class controllerClass) {
    String urlPrefix = "";
    RequestMapping requestMapping = AnnotationUtils.findAnnotation(controllerClass,
        RequestMapping.class);
    if (requestMapping != null) {
      urlPrefix = AnnotationUtils.getNotEmptyStr(requestMapping.value(), requestMapping.path());
    }
    List<Method> annoMethods = AnnotationUtils.extractAnnotationMethods(controllerClass,
        CollectThisApi.class);
   ...
   * @param apiUri
   */
  private static void buildRestApi(RestApiWrapper wrapper, String urlPrefix, ApiUri apiUri,
      CollectThisApi annotation) {
