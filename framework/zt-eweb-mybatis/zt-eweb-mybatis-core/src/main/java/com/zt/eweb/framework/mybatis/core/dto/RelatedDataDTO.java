...
import com.zt.eweb.framework.mybatis.core.controller.BaseController;
...
public class RelatedDataDTO implements Serializable {
  ...
  /**
   * <h3>筛选条件</h3>
   * 可重写{@link BaseController#buildRelatedDataCondition(RelatedDataDTO, QueryWrapper, Function)}
   * (RelatedDataDTO, QueryWrapper, Function)}进行自定义筛选条件规则
   */
  @Deprecated
