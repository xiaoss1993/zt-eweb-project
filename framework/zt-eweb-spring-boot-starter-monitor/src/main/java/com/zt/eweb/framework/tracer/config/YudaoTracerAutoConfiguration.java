package com.zt.eweb.framework.tracer.config;

import com.zt.eweb.framework.common.enums.WebFilterOrderEnum;
import com.zt.eweb.framework.tracer.core.aop.BizTraceAspect;
import com.zt.eweb.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "eweb.tracer", value = "enable", matchIfMissing = true)
