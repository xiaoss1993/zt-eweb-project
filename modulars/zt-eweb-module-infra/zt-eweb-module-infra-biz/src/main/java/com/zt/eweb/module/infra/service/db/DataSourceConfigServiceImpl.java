package com.zt.eweb.module.infra.service.db;

import static com.zt.eweb.framework.common.exception.util.ServiceExceptionUtil.exception;
import static com.zt.eweb.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
import static com.zt.eweb.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_OK;

import com.baomidou.dynamic.datasource.creator.DataSourceProperty;
import com.baomidou.dynamic.datasource.spring.boot.autoconfigure.DynamicDataSourceProperties;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.zt.eweb.framework.common.util.object.BeanUtils;
import com.zt.eweb.framework.mybatis.core.util.JdbcUtils;
import com.zt.eweb.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import com.zt.eweb.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.zt.eweb.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
public class DataSourceConfigServiceImpl implements DataSourceConfigService {
    ...
    public List<DataSourceConfigDO> getDataSourceConfigList() {
        List<DataSourceConfigDO> result = dataSourceConfigMapper.selectList(Wrappers.emptyWrapper());
        // 补充 master 数据源
