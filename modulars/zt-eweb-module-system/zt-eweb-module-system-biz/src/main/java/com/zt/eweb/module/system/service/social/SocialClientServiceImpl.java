package com.zt.eweb.module.system.service.social;
...
import com.zt.eweb.framework.common.util.cache.CacheUtils;
import com.zt.eweb.framework.common.util.http.HttpUtils;
import com.zt.eweb.framework.common.util.object.BeanUtils;
import com.zt.eweb.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.zt.eweb.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.zt.eweb.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.zt.eweb.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.zt.eweb.module.system.dal.dataobject.social.SocialClientDO;
import com.zt.eweb.module.system.dal.mysql.social.SocialClientMapper;
import com.zt.eweb.module.system.dal.redis.RedisKeyConstants;
import com.zt.eweb.module.system.enums.social.SocialTypeEnum;
...
import static com.zt.eweb.framework.common.util.collection.MapUtils.findAndThen;
import static com.zt.eweb.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${eweb.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${eweb.wxa-subscribe-message.miniprogram-state:formal}")
