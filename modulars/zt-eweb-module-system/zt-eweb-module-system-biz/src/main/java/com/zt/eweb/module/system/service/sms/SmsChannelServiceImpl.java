package com.zt.eweb.module.system.service.sms;

import com.zt.eweb.framework.common.pojo.PageResult;
import com.zt.eweb.framework.common.util.object.BeanUtils;
import com.zt.eweb.module.system.controller.admin.sms.vo.channel.SmsChannelPageReqVO;
import com.zt.eweb.module.system.controller.admin.sms.vo.channel.SmsChannelSaveReqVO;
import com.zt.eweb.module.system.dal.dataobject.sms.SmsChannelDO;
import com.zt.eweb.module.system.dal.mysql.sms.SmsChannelMapper;
import com.zt.eweb.module.system.framework.sms.core.client.SmsClient;
import com.zt.eweb.module.system.framework.sms.core.client.SmsClientFactory;
...
import static com.zt.eweb.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_HAS_CHILDREN;
import static com.zt.eweb.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_NOT_EXISTS;
